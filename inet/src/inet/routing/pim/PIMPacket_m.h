 ...
 * </pre>
 */
class INET_API HelloOption : public ::cObject
{
  protected:
    short type_var;
...
void INET_API doPacking(cCommBuffer *b, EncodedAddress& a);
void INET_API doUnpacking(cCommBuffer *b, EncodedAddress& a);
 ...
 * </pre>
 */
class INET_API JoinPruneGroup : public ::cObject
{
  protected:
 ...
 * </pre>
 */
class INET_API PIMPacket : public ::cPacket
{
  protected:
    short version_var;
    short type_var;
