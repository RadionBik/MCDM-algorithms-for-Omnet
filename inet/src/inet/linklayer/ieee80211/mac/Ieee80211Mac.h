...
class INET_API Ieee80211Mac : public MACProtocolBase
{
  ...
  protected:
    ...
    simtime_t beaconDelay = 0;
    simtime_t previousBeaconDelay = 0;
    std::list<simtime_t> beaconDelayList;
    std::list<simtime_t> beaconJitterList;

    simtime_t beaconJitter = 0;
  ...
  protected:
    ...
    struct Edca
    {
        ...
        simtime_t minjitter;
        simtime_t maxjitter;
        double throughputRecorded;
        simtime_t macDelayRecorded;
        simtime_t jitterRecorded;
    };
    ...
    virtual double& throughputRecorded(int i = -1);
    virtual simtime_t& macDelayRecorded(int i = -1);
    virtual simtime_t& jitterRecorded(int i = -1);
// out vectors
    ...
    // EEW
    double getAvrBeaconDelay(std::list<simtime_t> _beaconDelayList);
    double getAvrBeaconJitter(std::list<simtime_t> _beaconJitterList);
...
//    cMessage *endAIFS[4];
  ...
  protected:
    ...
    // EEW
    static simsignal_t beaconDelaySignal;
    static simsignal_t beaconJitterSignal;
