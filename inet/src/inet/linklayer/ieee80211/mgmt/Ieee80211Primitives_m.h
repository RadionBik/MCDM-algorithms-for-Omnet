...
class INET_API Ieee80211Prim_ScanRequest : public ::inet::ieee80211::Ieee80211PrimRequest
{
  ...
  public:
    ...
    virtual bool getRegularScan() const;
    virtual void setRegularScan(bool regularScan);
};
...
/**
 * Class generated from <tt>inet/linklayer/ieee80211/mgmt/Ieee80211Primitives.msg:125</tt> by nedtool.
 * <pre>
 ...
 *     double rxPower_dBm; // received power from AP; not part of the standard
 *     double snir; // calculated snir from AP; not part of the standard
 *     double delay;
 *     double jitter;
 *     double packetLoss;
 *     double throughputAP;
 *     double throughputAPOfAssocSTAs; // theoretical throughput of associated STAs and configured APPs 
 *     double throughputSTA;
 *     double maxBitrate;
 *     double availBitrate;
 *     double cost;
 * }
...
class INET_API Ieee80211Prim_BSSDescription : public ::cObject
{
  protected:
    ...
    double rxPower_var;
    double rxPower_dBm_var;
    double snir_var;
    double delay_var;
    double jitter_var;
    double packetLoss_var;
    double throughputAP_var;
    double throughputAPOfAssocSTAs_var;
    double throughputSTA_var;
    double maxBitrate_var;
    double availBitrate_var;
    double cost_var;
  ...
  public:
    ...
    virtual double getRxPower_dBm() const;
    virtual void setRxPower_dBm(double rxPower_dBm);
    ...
    virtual double getThroughputAP() const;
    virtual void setThroughputAP(double throughputAP);
    virtual double getThroughputAPOfAssocSTAs() const;
    virtual void setThroughputAPOfAssocSTAs(double throughputAPOfAssocSTAs);
    virtual double getThroughputSTA() const;
    virtual void setThroughputSTA(double throughputSTA);
    virtual double getMaxBitrate() const;
    virtual void setMaxBitrate(double maxBitrate);
    virtual double getAvailBitrate() const;
    virtual void setAvailBitrate(double availBitrate);
...
/**
 * Class generated from <tt>inet/linklayer/ieee80211/mgmt/Ieee80211Primitives.msg:151</tt> by nedtool.
 * <pre>
 * //
...
/**
 * Class generated from <tt>inet/linklayer/ieee80211/mgmt/Ieee80211Primitives.msg:164</tt> by nedtool.
 * <pre>
 * //
...
/**
 * Class generated from <tt>inet/linklayer/ieee80211/mgmt/Ieee80211Primitives.msg:195</tt> by nedtool.
 * <pre>
 * //
...
/**
 * Class generated from <tt>inet/linklayer/ieee80211/mgmt/Ieee80211Primitives.msg:213</tt> by nedtool.
 * <pre>
 * //
...
/**
 * Class generated from <tt>inet/linklayer/ieee80211/mgmt/Ieee80211Primitives.msg:220</tt> by nedtool.
 * <pre>
 * //
...
/**
 * Class generated from <tt>inet/linklayer/ieee80211/mgmt/Ieee80211Primitives.msg:231</tt> by nedtool.
 * <pre>
 * //
 ...
 * 
 * // EEW 
 * // a primitive to changeChannel to the channel of associated AP after a scanning
 * </pre>
 */
...
/**
 * Class generated from <tt>inet/linklayer/ieee80211/mgmt/Ieee80211Primitives.msg:240</tt> by nedtool.
 * <pre>
 * class Ieee80211Prim_ChangeChannelRequest extends Ieee80211PrimRequest
 * {
 *     int channelNummer;
 * }
 * </pre>
 */
class INET_API Ieee80211Prim_ChangeChannelRequest : public ::inet::ieee80211::Ieee80211PrimRequest
{
  protected:
    int channelNummer_var;

  private:
    void copy(const Ieee80211Prim_ChangeChannelRequest& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const Ieee80211Prim_ChangeChannelRequest&);

  public:
    Ieee80211Prim_ChangeChannelRequest();
    Ieee80211Prim_ChangeChannelRequest(const Ieee80211Prim_ChangeChannelRequest& other);
    virtual ~Ieee80211Prim_ChangeChannelRequest();
    Ieee80211Prim_ChangeChannelRequest& operator=(const Ieee80211Prim_ChangeChannelRequest& other);
    virtual Ieee80211Prim_ChangeChannelRequest *dup() const {return new Ieee80211Prim_ChangeChannelRequest(*this);}
    virtual void parsimPack(cCommBuffer *b);
    virtual void parsimUnpack(cCommBuffer *b);

    // field getter/setter methods
    virtual int getChannelNummer() const;
    virtual void setChannelNummer(int channelNummer);
};

inline void doPacking(cCommBuffer *b, Ieee80211Prim_ChangeChannelRequest& obj) {obj.parsimPack(b);}
inline void doUnpacking(cCommBuffer *b, Ieee80211Prim_ChangeChannelRequest& obj) {obj.parsimUnpack(b);}
