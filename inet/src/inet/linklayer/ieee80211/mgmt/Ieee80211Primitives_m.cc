...
void Ieee80211Prim_ScanRequest::copy(const Ieee80211Prim_ScanRequest& other)
{
    ...
    this->regularScan_var = other.regularScan_var;
}
...
void Ieee80211Prim_ScanRequest::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->regularScan_var);
}
...
void Ieee80211Prim_ScanRequest::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->regularScan_var);
}
...
bool Ieee80211Prim_ScanRequest::getRegularScan() const
{
    return regularScan_var;
}

void Ieee80211Prim_ScanRequest::setRegularScan(bool regularScan)
{
    this->regularScan_var = regularScan;
}
...
int Ieee80211Prim_ScanRequestDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='r' && strcmp(fieldName, "regularScan")==0) return base+8;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
std::string Ieee80211Prim_ScanRequestDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 8: return bool2string(pp->getRegularScan());
        default: return "";
    }
}
...
bool Ieee80211Prim_ScanRequestDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 8: pp->setRegularScan(string2bool(value)); return true;
        default: return false;
    }
}
...
Ieee80211Prim_BSSDescription::Ieee80211Prim_BSSDescription() : ::cObject()
{
    ...
    this->rxPower_var = 0;
    this->rxPower_dBm_var = 0;
    this->snir_var = 0;
    this->delay_var = 0;
    this->jitter_var = 0;
    this->packetLoss_var = 0;
    this->throughputAP_var = 0;
    this->throughputAPOfAssocSTAs_var = 0;
    this->throughputSTA_var = 0;
    this->maxBitrate_var = 0;
    this->availBitrate_var = 0;
    this->cost_var = 0;
}
...
void Ieee80211Prim_BSSDescription::copy(const Ieee80211Prim_BSSDescription& other)
{
    ...
    this->rxPower_dBm_var = other.rxPower_dBm_var;
    this->snir_var = other.snir_var;
    this->delay_var = other.delay_var;
    this->jitter_var = other.jitter_var;
    this->packetLoss_var = other.packetLoss_var;
    this->throughputAP_var = other.throughputAP_var;
    this->throughputAPOfAssocSTAs_var = other.throughputAPOfAssocSTAs_var;
    this->throughputSTA_var = other.throughputSTA_var;
    this->maxBitrate_var = other.maxBitrate_var;
    this->availBitrate_var = other.availBitrate_var;
...
void Ieee80211Prim_BSSDescription::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->rxPower_dBm_var);
    doPacking(b,this->snir_var);
    doPacking(b,this->delay_var);
    doPacking(b,this->jitter_var);
    doPacking(b,this->packetLoss_var);
    doPacking(b,this->throughputAP_var);
    doPacking(b,this->throughputAPOfAssocSTAs_var);
    doPacking(b,this->throughputSTA_var);
    doPacking(b,this->maxBitrate_var);
    doPacking(b,this->availBitrate_var);
...
void Ieee80211Prim_BSSDescription::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->rxPower_dBm_var);
    doUnpacking(b,this->snir_var);
    doUnpacking(b,this->delay_var);
    doUnpacking(b,this->jitter_var);
    doUnpacking(b,this->packetLoss_var);
    doUnpacking(b,this->throughputAP_var);
    doUnpacking(b,this->throughputAPOfAssocSTAs_var);
    doUnpacking(b,this->throughputSTA_var);
    doUnpacking(b,this->maxBitrate_var);
    doUnpacking(b,this->availBitrate_var);
...
double Ieee80211Prim_BSSDescription::getRxPower_dBm() const
{
    return rxPower_dBm_var;
}

void Ieee80211Prim_BSSDescription::setRxPower_dBm(double rxPower_dBm)
{
    this->rxPower_dBm_var = rxPower_dBm;
}

double Ieee80211Prim_BSSDescription::getSnir() const
{
    return snir_var;
}

void Ieee80211Prim_BSSDescription::setSnir(double snir)
{
    this->snir_var = snir;
}

double Ieee80211Prim_BSSDescription::getDelay() const
{
    return delay_var;
}

void Ieee80211Prim_BSSDescription::setDelay(double delay)
{
    this->delay_var = delay;
}

double Ieee80211Prim_BSSDescription::getJitter() const
{
    return jitter_var;
}

void Ieee80211Prim_BSSDescription::setJitter(double jitter)
{
    this->jitter_var = jitter;
}

double Ieee80211Prim_BSSDescription::getPacketLoss() const
{
    return packetLoss_var;
}

void Ieee80211Prim_BSSDescription::setPacketLoss(double packetLoss)
{
    this->packetLoss_var = packetLoss;
}

double Ieee80211Prim_BSSDescription::getThroughputAP() const
{
    return throughputAP_var;
}

void Ieee80211Prim_BSSDescription::setThroughputAP(double throughputAP)
{
    this->throughputAP_var = throughputAP;
}

double Ieee80211Prim_BSSDescription::getThroughputAPOfAssocSTAs() const
{
    return throughputAPOfAssocSTAs_var;
}

void Ieee80211Prim_BSSDescription::setThroughputAPOfAssocSTAs(double throughputAPOfAssocSTAs)
{
    this->throughputAPOfAssocSTAs_var = throughputAPOfAssocSTAs;
}

double Ieee80211Prim_BSSDescription::getThroughputSTA() const
{
    return throughputSTA_var;
}

void Ieee80211Prim_BSSDescription::setThroughputSTA(double throughputSTA)
{
    this->throughputSTA_var = throughputSTA;
}

double Ieee80211Prim_BSSDescription::getMaxBitrate() const
{
    return maxBitrate_var;
}

void Ieee80211Prim_BSSDescription::setMaxBitrate(double maxBitrate)
{
    this->maxBitrate_var = maxBitrate;
}

double Ieee80211Prim_BSSDescription::getAvailBitrate() const
{
    return availBitrate_var;
}

void Ieee80211Prim_BSSDescription::setAvailBitrate(double availBitrate)
{
    this->availBitrate_var = availBitrate;
}

double Ieee80211Prim_BSSDescription::getCost() const
{
    return cost_var;
}

void Ieee80211Prim_BSSDescription::setCost(double cost)
{
    this->cost_var = cost;
}
...
int Ieee80211Prim_BSSDescriptionDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='r' && strcmp(fieldName, "rxPower_dBm")==0) return base+6;
    if (fieldName[0]=='s' && strcmp(fieldName, "snir")==0) return base+7;
    if (fieldName[0]=='d' && strcmp(fieldName, "delay")==0) return base+8;
    if (fieldName[0]=='j' && strcmp(fieldName, "jitter")==0) return base+9;
    if (fieldName[0]=='p' && strcmp(fieldName, "packetLoss")==0) return base+10;
    if (fieldName[0]=='t' && strcmp(fieldName, "throughputAP")==0) return base+11;
    if (fieldName[0]=='t' && strcmp(fieldName, "throughputAPOfAssocSTAs")==0) return base+12;
    if (fieldName[0]=='t' && strcmp(fieldName, "throughputSTA")==0) return base+13;
    if (fieldName[0]=='m' && strcmp(fieldName, "maxBitrate")==0) return base+14;
    if (fieldName[0]=='a' && strcmp(fieldName, "availBitrate")==0) return base+15;
    if (fieldName[0]=='c' && strcmp(fieldName, "cost")==0) return base+16;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
std::string Ieee80211Prim_BSSDescriptionDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 6: return double2string(pp->getRxPower_dBm());
        case 7: return double2string(pp->getSnir());
        case 8: return double2string(pp->getDelay());
        case 9: return double2string(pp->getJitter());
        case 10: return double2string(pp->getPacketLoss());
        case 11: return double2string(pp->getThroughputAP());
        case 12: return double2string(pp->getThroughputAPOfAssocSTAs());
        case 13: return double2string(pp->getThroughputSTA());
        case 14: return double2string(pp->getMaxBitrate());
        case 15: return double2string(pp->getAvailBitrate());
        case 16: return double2string(pp->getCost());
        default: return "";
    }
}
...
bool Ieee80211Prim_BSSDescriptionDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 6: pp->setRxPower_dBm(string2double(value)); return true;
        case 7: pp->setSnir(string2double(value)); return true;
        case 8: pp->setDelay(string2double(value)); return true;
        case 9: pp->setJitter(string2double(value)); return true;
        case 10: pp->setPacketLoss(string2double(value)); return true;
        case 11: pp->setThroughputAP(string2double(value)); return true;
        case 12: pp->setThroughputAPOfAssocSTAs(string2double(value)); return true;
        case 13: pp->setThroughputSTA(string2double(value)); return true;
        case 14: pp->setMaxBitrate(string2double(value)); return true;
        case 15: pp->setAvailBitrate(string2double(value)); return true;
        case 16: pp->setCost(string2double(value)); return true;
        default: return false;
    }
}
...
Register_Class(Ieee80211Prim_ChangeChannelRequest);

Ieee80211Prim_ChangeChannelRequest::Ieee80211Prim_ChangeChannelRequest() : ::inet::ieee80211::Ieee80211PrimRequest()
{
    this->channelNummer_var = 0;
}

Ieee80211Prim_ChangeChannelRequest::Ieee80211Prim_ChangeChannelRequest(const Ieee80211Prim_ChangeChannelRequest& other) : ::inet::ieee80211::Ieee80211PrimRequest(other)
{
    copy(other);
}

Ieee80211Prim_ChangeChannelRequest::~Ieee80211Prim_ChangeChannelRequest()
{
}

Ieee80211Prim_ChangeChannelRequest& Ieee80211Prim_ChangeChannelRequest::operator=(const Ieee80211Prim_ChangeChannelRequest& other)
{
    if (this==&other) return *this;
    ::inet::ieee80211::Ieee80211PrimRequest::operator=(other);
    copy(other);
...
void Ieee80211Prim_ChangeChannelRequest::copy(const Ieee80211Prim_ChangeChannelRequest& other)
{
    this->channelNummer_var = other.channelNummer_var;
}

void Ieee80211Prim_ChangeChannelRequest::parsimPack(cCommBuffer *b)
{
    ::inet::ieee80211::Ieee80211PrimRequest::parsimPack(b);
    doPacking(b,this->channelNummer_var);
}

void Ieee80211Prim_ChangeChannelRequest::parsimUnpack(cCommBuffer *b)
{
    ::inet::ieee80211::Ieee80211PrimRequest::parsimUnpack(b);
    doUnpacking(b,this->channelNummer_var);
}

int Ieee80211Prim_ChangeChannelRequest::getChannelNummer() const
{
    return channelNummer_var;
}

void Ieee80211Prim_ChangeChannelRequest::setChannelNummer(int channelNummer)
{
    this->channelNummer_var = channelNummer;
}

class Ieee80211Prim_ChangeChannelRequestDescriptor : public cClassDescriptor
{
  public:
    Ieee80211Prim_ChangeChannelRequestDescriptor();
    virtual ~Ieee80211Prim_ChangeChannelRequestDescriptor();
...
Register_ClassDescriptor(Ieee80211Prim_ChangeChannelRequestDescriptor);

Ieee80211Prim_ChangeChannelRequestDescriptor::Ieee80211Prim_ChangeChannelRequestDescriptor() : cClassDescriptor("inet::ieee80211::Ieee80211Prim_ChangeChannelRequest", "inet::ieee80211::Ieee80211PrimRequest")
{
}

Ieee80211Prim_ChangeChannelRequestDescriptor::~Ieee80211Prim_ChangeChannelRequestDescriptor()
{
}

bool Ieee80211Prim_ChangeChannelRequestDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<Ieee80211Prim_ChangeChannelRequest *>(obj)!=NULL;
}

const char *Ieee80211Prim_ChangeChannelRequestDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int Ieee80211Prim_ChangeChannelRequestDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 1+basedesc->getFieldCount(object) : 1;
}

unsigned int Ieee80211Prim_ChangeChannelRequestDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *Ieee80211Prim_ChangeChannelRequestDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int Ieee80211Prim_ChangeChannelRequestDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='c' && strcmp(fieldName, "channelNummer")==0) return base+0;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}

const char *Ieee80211Prim_ChangeChannelRequestDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *Ieee80211Prim_ChangeChannelRequestDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int Ieee80211Prim_ChangeChannelRequestDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    Ieee80211Prim_ChangeChannelRequest *pp = (Ieee80211Prim_ChangeChannelRequest *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string Ieee80211Prim_ChangeChannelRequestDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    Ieee80211Prim_ChangeChannelRequest *pp = (Ieee80211Prim_ChangeChannelRequest *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getChannelNummer());
        default: return "";
    }
}

bool Ieee80211Prim_ChangeChannelRequestDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    Ieee80211Prim_ChangeChannelRequest *pp = (Ieee80211Prim_ChangeChannelRequest *)object; (void)pp;
    switch (field) {
        case 0: pp->setChannelNummer(string2long(value)); return true;
        default: return false;
    }
}

const char *Ieee80211Prim_ChangeChannelRequestDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *Ieee80211Prim_ChangeChannelRequestDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
