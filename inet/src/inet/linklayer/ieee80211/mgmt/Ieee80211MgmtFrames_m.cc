...
void Ieee80211BeaconFrameBody::copy(const Ieee80211BeaconFrameBody& other)
{
    ...
    this->throughputTotalAP_var = other.throughputTotalAP_var;
...
void Ieee80211BeaconFrameBody::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->throughputTotalAP_var);
...
void Ieee80211BeaconFrameBody::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->throughputTotalAP_var);
...
double Ieee80211BeaconFrameBody::getThroughputTotalAP() const
{
    return throughputTotalAP_var;
}

void Ieee80211BeaconFrameBody::setThroughputTotalAP(double throughputTotalAP)
{
    this->throughputTotalAP_var = throughputTotalAP;
}

simtime_t Ieee80211BeaconFrameBody::getDelay() const
{
    return delay_var;
}

void Ieee80211BeaconFrameBody::setDelay(simtime_t delay)
{
    this->delay_var = delay;
}

simtime_t Ieee80211BeaconFrameBody::getJitter() const
{
    return jitter_var;
}

void Ieee80211BeaconFrameBody::setJitter(simtime_t jitter)
{
    this->jitter_var = jitter;
}

double Ieee80211BeaconFrameBody::getPacketLoss() const
{
    return packetLoss_var;
}

void Ieee80211BeaconFrameBody::setPacketLoss(double packetLoss)
{
...
int Ieee80211BeaconFrameBodyDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='t' && strcmp(fieldName, "throughputTotalAP")==0) return base+5;
    if (fieldName[0]=='d' && strcmp(fieldName, "delay")==0) return base+6;
    if (fieldName[0]=='j' && strcmp(fieldName, "jitter")==0) return base+7;
...
std::string Ieee80211BeaconFrameBodyDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 5: return double2string(pp->getThroughputTotalAP());
        case 6: return double2string(pp->getDelay());
        case 7: return double2string(pp->getJitter());
...
bool Ieee80211BeaconFrameBodyDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 5: pp->setThroughputTotalAP(string2double(value)); return true;
        case 6: pp->setDelay(string2double(value)); return true;
        case 7: pp->setJitter(string2double(value)); return true;
...
Ieee80211ActionHWMPFrameBody::Ieee80211ActionHWMPFrameBody() : ::inet::ieee80211::Ieee80211ActionFrameBody()
{
    this->id_var = 0;
    this->flags_var = 0;
...
Ieee80211ActionHWMPFrameBody::Ieee80211ActionHWMPFrameBody(const Ieee80211ActionHWMPFrameBody& other) : ::inet::ieee80211::Ieee80211ActionFrameBody(other)
{
    copy(other);
}
...
Ieee80211ActionHWMPFrameBodyDescriptor::Ieee80211ActionHWMPFrameBodyDescriptor() : cClassDescriptor("inet::ieee80211::Ieee80211ActionHWMPFrameBody", "inet::ieee80211::Ieee80211ActionFrameBody")
{
}
...
Ieee80211ActionRANNFrameBody::Ieee80211ActionRANNFrameBody() : ::inet::ieee80211::Ieee80211ActionHWMPFrameBody()
{
...
Ieee80211ActionRANNFrameBody::Ieee80211ActionRANNFrameBody(const Ieee80211ActionRANNFrameBody& other) : ::inet::ieee80211::Ieee80211ActionHWMPFrameBody(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inet::ieee80211::Ieee80211ActionHWMPFrameBody::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inet::ieee80211::Ieee80211ActionHWMPFrameBody::parsimPack(b);
...
{
    ::inet::ieee80211::Ieee80211ActionHWMPFrameBody::parsimUnpack(b);
...
Ieee80211ActionRANNFrameBodyDescriptor::Ieee80211ActionRANNFrameBodyDescriptor() : cClassDescriptor("inet::ieee80211::Ieee80211ActionRANNFrameBody", "inet::ieee80211::Ieee80211ActionHWMPFrameBody")
{
}
...
Ieee80211ActionPREQFrameBody::Ieee80211ActionPREQFrameBody() : ::inet::ieee80211::Ieee80211ActionHWMPFrameBody()
{
    this->setBodyLength(26);
...
Ieee80211ActionPREQFrameBody::Ieee80211ActionPREQFrameBody(const Ieee80211ActionPREQFrameBody& other) : ::inet::ieee80211::Ieee80211ActionHWMPFrameBody(other)
{
    preqElem_arraysize = 0;
    this->preqElem_var = 0;
    copy(other);
...
Ieee80211ActionPREQFrameBodyDescriptor::Ieee80211ActionPREQFrameBodyDescriptor() : cClassDescriptor("inet::ieee80211::Ieee80211ActionPREQFrameBody", "inet::ieee80211::Ieee80211ActionHWMPFrameBody")
{
}
...
Ieee80211ActionPREPFrameBody::Ieee80211ActionPREPFrameBody() : ::inet::ieee80211::Ieee80211ActionHWMPFrameBody()
{
...
Ieee80211ActionPREPFrameBody::Ieee80211ActionPREPFrameBody(const Ieee80211ActionPREPFrameBody& other) : ::inet::ieee80211::Ieee80211ActionHWMPFrameBody(other)
{
    copy(other);
}
...
Ieee80211ActionPREPFrameBodyDescriptor::Ieee80211ActionPREPFrameBodyDescriptor() : cClassDescriptor("inet::ieee80211::Ieee80211ActionPREPFrameBody", "inet::ieee80211::Ieee80211ActionHWMPFrameBody")
{
}
...
Ieee80211ActionPERRFrameBody::Ieee80211ActionPERRFrameBody() : ::inet::ieee80211::Ieee80211ActionHWMPFrameBody()
{
    this->setBodyLength(2);
...
Ieee80211ActionPERRFrameBody::Ieee80211ActionPERRFrameBody(const Ieee80211ActionPERRFrameBody& other) : ::inet::ieee80211::Ieee80211ActionHWMPFrameBody(other)
{
    perrElem_arraysize = 0;
    this->perrElem_var = 0;
    copy(other);
...
Ieee80211ActionPERRFrameBodyDescriptor::Ieee80211ActionPERRFrameBodyDescriptor() : cClassDescriptor("inet::ieee80211::Ieee80211ActionPERRFrameBody", "inet::ieee80211::Ieee80211ActionHWMPFrameBody")
{
}
...
Ieee80211ActionGANNFrameBody::Ieee80211ActionGANNFrameBody() : ::inet::ieee80211::Ieee80211ActionHWMPFrameBody()
{
...
Ieee80211ActionGANNFrameBody::Ieee80211ActionGANNFrameBody(const Ieee80211ActionGANNFrameBody& other) : ::inet::ieee80211::Ieee80211ActionHWMPFrameBody(other)
{
    copy(other);
}
...
Ieee80211ActionGANNFrameBodyDescriptor::Ieee80211ActionGANNFrameBodyDescriptor() : cClassDescriptor("inet::ieee80211::Ieee80211ActionGANNFrameBody", "inet::ieee80211::Ieee80211ActionHWMPFrameBody")
{
}
