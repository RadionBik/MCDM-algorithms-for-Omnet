...
public:
    ...
    struct APInfo {
        ...
        APInfo() {
            ...
            // EEW 1
            beaconInterval = rxPower = snir = packetErrorRate = 0;
...
public:
    Ieee80211MgmtSTA() :
            host(nullptr), interfaceTable(nullptr), myIface(nullptr), numChannels(
                    -1), isScanning(false), isAssociated(false), assocTimeoutMsg(
                    nullptr) {
    }
...
protected:
    ...
    virtual void storeAPInfo(const MACAddress& address,
